...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'admin', '$2a$10$TCkdHhF9XkbkLWNw1rf.WevjvfDtaJF7ZTZDmCF1TLDqCqhuw9nvW', '管理员', '总裁办', '系统管理员', 'admin@admin.com', NULL, NULL, '', NULL, '0');
